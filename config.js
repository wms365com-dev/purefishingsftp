...
function loadConfig() {
  ...
  return {
    ...
    opsTimelineLookbackDays: Math.min(Math.max(parseNumber(process.env.OPS_TIMELINE_LOOKBACK_DAYS, 90), 7), 365),
...
function getPublicConfig(config) {
  ...
  return {
    ...
    opsTimelineLookbackDays: config.opsTimelineLookbackDays,
